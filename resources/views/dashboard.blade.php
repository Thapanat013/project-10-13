  ...
  <div class="container-scroller"> 
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="{{ asset('backend/dashboard.html')}}">
            <img src="{{ asset('backend/images/logo.svg')}}" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="{{ asset('backend/dashboard.html')}}">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">ก๋วยเตี๋ยว<span class="text-black fw-bold">หมูตุ๋น</span></h1>
            <h3 class="welcome-sub-text">ก๋วยเตี๋ยวอร่อย</h3>
          </li>
        </ul>
          ...
          <li class="nav-item dropdown d-none d-lg-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="fw-light text-muted mb-0">admin1@gmail.com</p>
              </div>
            </div>
          </li>
        </ul>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">รายการอาหาร</li>
          <li class="nav-item">
